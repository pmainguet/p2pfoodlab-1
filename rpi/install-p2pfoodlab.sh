...
if [ "$first_time" == "yes" ]; then
    ...
    apt-get install apache2 php5 libapache2-mod-php5 gcc libjpeg62-dev i2c-tools libi2c-dev git libcurl4-gnutls-dev bc wvdial ssh libv4l-dev emacs23-nox avahi-daemon ntp
else
    apt-get --yes upgrade
fi
